...
function Signup() {
  ...
  return (
    <div style={{background: 'linear-gradient(45deg, #0C0C0C, #481E14)'}} className='w-full flex justify-center items-center h-screen'>
        <div className='w-[28vmax] border-2 h-[35vmax] p-[1vmax] rounded-[0.5vmax] flex flex-col text-white'>
            ...
            <div className='text-[1.1vmax]'> Already Have an Account?.. <span className='font-bold cursor-pointer'>Login</span> </div>
        </div>
        </div>
    </div>
  )
